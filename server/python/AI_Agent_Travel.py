...
# print(ask_ai_agent("Find flights to Greece."))
# print(ask_ai_agent("What country is mentioned in this greece sentence?"))
# print(ask_ai_agent("What are the valid countries in the database?"))
# print(ask_ai_agent("What are the flight available to Greece?"))
# print(ask_ai_agent("Get vacations for a given country name: Greece.")) #this works at last!
